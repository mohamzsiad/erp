...
async function main() {
    ...
    const [headOffice, enggStore, mainWarehouse] = await Promise.all([
        prisma.location.upsert({
            ...
            update: {},
            create: { companyId: company.id, code: 'HEAD_OFFICE', name: 'Head Office', type: client_1.LocationType.OFFICE, address: 'Muscat, Oman' },
        }),
        prisma.location.upsert({
            where: { companyId_code: { companyId: company.id, code: 'ENGG_STORE' } },
            update: {},
            create: { companyId: company.id, code: 'ENGG_STORE', name: 'Store for Engineering Items', type: client_1.LocationType.WAREHOUSE, address: 'Muscat, Oman' },
        }),
        prisma.location.upsert({
            where: { companyId_code: { companyId: company.id, code: 'MAIN_WH' } },
            update: {},
            create: { companyId: company.id, code: 'MAIN_WH', name: 'Main Warehouse', type: client_1.LocationType.WAREHOUSE, address: 'Muscat, Oman' },
        }),
    ]);
    ...
    const glData = [
        // Assets
        { code: '1000', name: 'Current Assets', accountType: 'ASSET', parentId: null },
        { code: '1100', name: 'Cash and Bank', accountType: 'ASSET', parentCode: '1000' },
        { code: '1110', name: 'Main Bank Account', accountType: 'ASSET', parentCode: '1100' },
        { code: '1200', name: 'Accounts Receivable', accountType: 'ASSET', parentCode: '1000', isControl: true },
        { code: '1300', name: 'Inventory Account', accountType: 'ASSET', parentCode: '1000' },
        { code: '1310', name: 'Raw Materials Stock', accountType: 'ASSET', parentCode: '1300' },
        // Liabilities
        { code: '2000', name: 'Current Liabilities', accountType: 'LIABILITY', parentId: null },
        { code: '2100', name: 'Accounts Payable', accountType: 'LIABILITY', parentCode: '2000', isControl: true },
        { code: '2200', name: 'GRN Clearing', accountType: 'LIABILITY', parentCode: '2000' },
        { code: '2300', name: 'Sundry Creditors', accountType: 'LIABILITY', parentCode: '2000', isControl: true },
        // Equity
        { code: '3000', name: 'Equity', accountType: 'EQUITY', parentId: null },
        { code: '3100', name: 'Retained Earnings', accountType: 'EQUITY', parentCode: '3000' },
        // Revenue
        { code: '4000', name: 'Revenue', accountType: 'REVENUE', parentId: null },
        { code: '4100', name: 'Sales Revenue', accountType: 'REVENUE', parentCode: '4000' },
        // Expenses
        { code: '5000', name: 'Operating Expenses', accountType: 'EXPENSE', parentId: null },
        { code: '5100', name: 'Cost of Goods Sold', accountType: 'EXPENSE', parentCode: '5000' },
        { code: '5200', name: 'General & Admin', accountType: 'EXPENSE', parentCode: '5000' },
        { code: '5300', name: 'Purchase Expense', accountType: 'EXPENSE', parentCode: '5000' },
    ];
    const glMap = {}; // code -> id
    ...
    const adminPerms = [
        ...
        ...['USERS', 'ROLES', 'CONFIG', 'SEQUENCES'].map(r => ([
            { module: client_1.Module.CORE, resource: r, action: client_1.PermissionAction.VIEW },
            { module: client_1.Module.CORE, resource: r, action: client_1.PermissionAction.CREATE },
            { module: client_1.Module.CORE, resource: r, action: client_1.PermissionAction.EDIT },
            { module: client_1.Module.CORE, resource: r, action: client_1.PermissionAction.DELETE },
            { module: client_1.Module.CORE, resource: r, action: client_1.PermissionAction.CONFIGURE },
        ])).flat(),
        ...['SUPPLIERS', 'MRL', 'PRL', 'ENQUIRY', 'QUOTATION', 'PO', 'SUPPLIER_RETURN'].map(r => ([
            { module: client_1.Module.PROCUREMENT, resource: r, action: client_1.PermissionAction.VIEW },
            { module: client_1.Module.PROCUREMENT, resource: r, action: client_1.PermissionAction.CREATE },
            { module: client_1.Module.PROCUREMENT, resource: r, action: client_1.PermissionAction.EDIT },
            { module: client_1.Module.PROCUREMENT, resource: r, action: client_1.PermissionAction.APPROVE },
            { module: client_1.Module.PROCUREMENT, resource: r, action: client_1.PermissionAction.DELETE },
            { module: client_1.Module.PROCUREMENT, resource: r, action: client_1.PermissionAction.VOID },
        ])).flat(),
        { module: client_1.Module.PROCUREMENT, resource: 'REPORTS', action: client_1.PermissionAction.VIEW },
        ...['ITEMS', 'WAREHOUSES', 'BIN', 'GRN', 'STOCK_ISSUE', 'STOCK_TRANSFER', 'STOCK_ADJUSTMENT', 'PHYSICAL_COUNT'].map(r => ([
            { module: client_1.Module.INVENTORY, resource: r, action: client_1.PermissionAction.VIEW },
            { module: client_1.Module.INVENTORY, resource: r, action: client_1.PermissionAction.CREATE },
            { module: client_1.Module.INVENTORY, resource: r, action: client_1.PermissionAction.EDIT },
            { module: client_1.Module.INVENTORY, resource: r, action: client_1.PermissionAction.APPROVE },
            { module: client_1.Module.INVENTORY, resource: r, action: client_1.PermissionAction.DELETE },
        ])).flat(),
        { module: client_1.Module.INVENTORY, resource: 'REPORTS', action: client_1.PermissionAction.VIEW },
        { module: client_1.Module.INVENTORY, resource: 'STOCK_SUMMARY', action: client_1.PermissionAction.VIEW },
        ...['GL_ACCOUNT', 'COST_CENTER', 'JOURNAL', 'AP', 'AR', 'BUDGET', 'PERIOD', 'ACCOUNT_MAPPING', 'REPORT'].map(r => ([
            { module: client_1.Module.FINANCE, resource: r, action: client_1.PermissionAction.VIEW },
            { module: client_1.Module.FINANCE, resource: r, action: client_1.PermissionAction.CREATE },
            { module: client_1.Module.FINANCE, resource: r, action: client_1.PermissionAction.EDIT },
            { module: client_1.Module.FINANCE, resource: r, action: client_1.PermissionAction.APPROVE },
            { module: client_1.Module.FINANCE, resource: r, action: client_1.PermissionAction.DELETE },
        ])).flat(),
    ];
    const procMgrPerms = [
        ...['SUPPLIERS', 'MRL', 'PRL', 'ENQUIRY', 'QUOTATION', 'PO', 'SUPPLIER_RETURN'].map(r => ([
    ...
    for (const m of accountMappingDefs) {
        ...
        if (!accountId) {
            console.warn(`  ⚠ GL account ${m.accountCode} not found — skipping ${m.mappingType}`);
            continue;
        }
